...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-b-[#29A8DF] text-sm font-medium leading-5 text-[#29A8DF] focus:outline-none focus:border-indigo-700 transition'
