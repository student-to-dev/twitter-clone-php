<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 min-h-screen w-32 sticky top-0" style="align-self: flex-start">
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link class="text-gray-100" href="{{ route('profile.show') }}">
                                {{ __('Profile') }}
                            </x-jet-dropdown-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('all-posts') }}" :active="request()->routeIs('all-posts')">
                {{ __('All Posts') }}
