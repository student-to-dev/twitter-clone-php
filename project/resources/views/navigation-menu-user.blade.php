<nav x-data="{ open: false }" class="bg-[#1F2C3C] border-b border-gray-600 pb-2 sticky top-0">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 ">
                ...
                <div class="ml-3 relative ">
                    <x-jet-dropdown align="right" width="48" class="bg-[#29a8df]">
                        ...
                        <x-slot name="content">
                            <!-- Account Management -->
                            <div class="block px-4 py-2 text-xs text-gray-100 font-semibold">
                                {{ __('Manage Account') }}
                            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link class="text-gray-100" href="{{ route('all-posts') }}" :active="request()->routeIs('all-posts')">
                {{ __('All Posts') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link class="text-gray-100" href="{{ route('log-out') }}" :active="request()->routeIs('log-out')">
                {{ __('LEAVE') }}
            </x-jet-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                <x-jet-responsive-nav-link class="text-gray-100" href="{{ route('profile.show') }}" :active="request()->routeIs('profile.show')">
                    {{ __('Profile') }}
                </x-jet-responsive-nav-link>
